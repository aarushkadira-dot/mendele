    ...
    <div className="h-full flex flex-col p-6">
      ...
      <div className="grid grid-cols-2 gap-3 h-full">
        ...
        <Link href="/projects" className="group flex flex-col items-center justify-center p-4 rounded-xl bg-accent/30 hover:bg-accent border border-border/50 hover:border-primary/30 transition-all duration-300">
          <PlusCircle className="w-6 h-6 mb-2 text-blue-400 group-hover:scale-110 transition-transform" />
          <span className="text-xs font-medium text-center">Add Project</span>
        </Link>

        <Link href="/assistant" className="col-span-2 group flex items-center justify-between px-6 py-3 rounded-xl    hover: border border-primary/20 hover:border-primary/50 transition-all duration-300">
