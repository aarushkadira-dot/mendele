...
import { Loader2, Search, Database, Rss, Map, RefreshCw, CheckCircle2, XCircle } from "@/components/ui/icons"
...
export function BatchDiscoveryPanel({ onComplete }: BatchDiscoveryPanelProps) {
 ...
 return <Icon className="h-5 w-5 animate-pulse text-blue-400" />
 })()}
 ...
 {event.type === "error" && <XCircle className="h-3 w-3 text-blue-400 mt-0.5" />}
 {event.type === "success" && <CheckCircle2 className="h-3 w-3 text-blue-400 mt-0.5" />}
