    ...
    <div className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
      <div className="absolute aspect-[24/16] left-0 right-0 top-1/2 -translate-y-1/2">
        <svg className="block size-full" fill="none" viewBox="0 0 24 16">
          <g>
            <path d={svgPaths.p36880f80} fill="#111827" />
            <path d={svgPaths.p355df480} fill="#111827" />
            <path d={svgPaths.pfa0d600} fill="#111827" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="relative shrink-0 w-full mb-4">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div className="font-['Lexend:SemiBold',_sans-serif] text-[16px] text-gray-900 font-bold">
            Networkly
          </div>
        </div>
      </div>
...
function AvatarCircle() {
  ...
  if (avatar) {
    return (
      <div className="relative rounded-full shrink-0 size-8 bg-gray-100 overflow-hidden">
  ...
  return (
    <div className="relative rounded-full shrink-0 size-8 bg-gray-100">
      <div className="flex items-center justify-center size-8">
        <UserIcon size={16} className="text-gray-900" />
      </div>
      <div
        aria-hidden="true"
        className="absolute inset-0 rounded-full border border-gray-200 pointer-events-none"
      />
    </div>
  );
}
...
function SearchContainer({ isCollapsed = false }: { isCollapsed?: boolean }) {
  ...
  return (
    ...
    >
      <div
        className={`bg-white border border-gray-200 h-10 relative rounded-lg flex items-center transition-all duration-500 ${
          ...
          <div className="flex flex-col justify-center size-full">
            <div className="flex flex-col gap-2 items-start justify-center pr-2 py-1 w-full">
              <input
                ...
                className="w-full bg-transparent border-none outline-none font-sans text-sm text-gray-900 placeholder:text-gray-400 leading-[20px]"
      ...
      sections: [
        {
          title: "Core Features",
          items: [
            { icon: <View size={16} className="text-gray-900" />, label: "Dashboard", href: "/dashboard" },
            { icon: <UserIcon size={16} className="text-gray-900" />, label: "Profile", href: "/profile" },
            { icon: <Briefcase size={16} className="text-gray-900" />, label: "Opportunities", href: "/opportunities" },
            { icon: <MessageSquare size={16} className="text-gray-900" />, label: "Network", href: "/network" },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: "Community",
          items: [
            { icon: <Folder size={16} className="text-gray-900" />, label: "Projects", href: "/projects" },
            { icon: <Building2 size={16} className="text-gray-900" />, label: "Business", href: "/business" },
            { icon: <Users size={16} className="text-gray-900" />, label: "Researchers", href: "/researchers" },
            { icon: <TestTube size={16} className="text-gray-900" />, label: "Research", href: "/research" },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: "AI Tools",
          items: [
            { icon: <Sparkles size={16} className="text-gray-900" />, label: "AI Assistant", href: "/assistant" },
            { icon: <Analytics size={16} className="text-gray-900" />, label: "Analytics", href: "/analytics" }
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: "Account",
          items: [
            { icon: <UserIcon size={16} className="text-gray-900" />, label: "Profile & Appearance", href: "/settings?tab=profile" },
            { icon: <SettingsIcon size={16} className="text-gray-900" />, label: "System & Preferences", href: "/settings?tab=preferences" },
          ],
        },
      ],
    },
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center rounded-lg size-10 min-w-10 transition-colors duration-500 cursor-pointer
        ${isActive ? "bg-gray-100 text-gray-900" : "hover:bg-gray-100 text-gray-500 hover:text-gray-700"}`}
      style={{ transitionTimingFunction: softSpringEasing }}
      onClick={onClick}
    >
      {children}
...
import { LayoutDashboard, Users, FlaskConical as TestTube, MessageSquare, Briefcase, Sparkles, Building2 } from "@/components/ui/icons"
...
function IconNavigation({
  ...
  return (
    <aside className="bg-white flex flex-col gap-2 items-center p-4 w-16 h-screen border-r border-gray-200">
      {/* Logo */}
      <div className="mb-2 size-10 flex items-center justify-center cursor-pointer">
      ...
      <div className="flex flex-col gap-2 w-full items-center">
        <IconNavButton isActive={activeSection === "dashboard"} onClick={() => onSectionChange("dashboard")}>
          <LayoutDashboard size={18} />
        </IconNavButton>
        <IconNavButton isActive={activeSection === "discover"} onClick={() => onSectionChange("discover")}>
          <Users size={18} />
        </IconNavButton>
        <IconNavButton isActive={activeSection === "intelligence"} onClick={() => onSectionChange("intelligence")}>
          <Sparkles size={18} />
        </IconNavButton>
      </div>
      ...
      {/* Bottom section */}
      <div className="flex flex-col gap-2 w-full items-center pb-4">
...
function SectionTitle({
  ...
  if (isCollapsed) {
    return (
      <div className="w-full flex justify-center transition-all duration-500 my-2" style={{ transitionTimingFunction: softSpringEasing }}>
        <button
          type="button"
          onClick={onToggleCollapse}
          className="flex items-center justify-center rounded-lg size-10 min-w-10 transition-all duration-500 hover:bg-gray-100 text-gray-500 hover:text-gray-700 cursor-pointer"
          style={{ transitionTimingFunction: softSpringEasing }}
  ...
  return (
    <div className="w-full overflow-hidden transition-all duration-500 mb-2" style={{ transitionTimingFunction: softSpringEasing }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center h-10">
          <div className="px-2 py-1">
            <div className="font-['Lexend:SemiBold',_sans-serif] text-[18px] text-gray-900 font-medium">
              {title}
            </div>
          </div>
        </div>
...
function DetailSidebar({ activeSection, isCollapsed, toggleCollapse }: { activeSection: string, isCollapsed: boolean, toggleCollapse: () => void }) {
  ...
  return (
    <aside
      className={`bg-gray-50 flex flex-col items-start px-4 py-6 border-r border-gray-200 transition-all duration-500 h-screen ${
        isCollapsed ? "w-16 min-w-16 !px-2 justify-start items-center" : "w-64"
      }`}
      style={{ transitionTimingFunction: softSpringEasing }}
    >
      ...
      <div
        className={`flex flex-col w-full overflow-y-auto transition-all duration-500 ${
          isCollapsed ? "gap-2 items-center flex-1 justify-center pb-64" : "gap-4 items-start"
        }`}
        style={{ transitionTimingFunction: softSpringEasing }}
      >
      ...
      {!isCollapsed && (
        <div className="w-full mt-auto pt-2 border-t border-gray-200">
          <div className="flex items-center gap-2 px-2 py-2">
            <AvatarCircle />
            <div className="font-medium text-sm text-gray-900 truncate flex-1">{userName}</div>
            <button
              type="button"
              className="ml-auto size-8 rounded-md flex items-center justify-center hover:bg-gray-200 cursor-pointer"
              aria-label="More"
            >
              <svg className="size-4" viewBox="0 0 16 16" fill="none">
                <circle cx="4" cy="8" r="1" fill="#4b5563" />
                <circle cx="8" cy="8" r="1" fill="#4b5563" />
                <circle cx="12" cy="8" r="1" fill="#4b5563" />
              </svg>
            </button>
          </div>
        </div>
...
function MenuItem({
  ...
  const isActive = item.href ? pathname === item.href || pathname.startsWith(item.href + "/") : item.isActive;
  ...
  const linkEl = (
    <div
      className={`rounded-lg cursor-pointer transition-all duration-500 flex items-center relative ${
        isActive ? "bg-gray-200 text-gray-900" : "hover:bg-gray-100 text-gray-600 hover:text-gray-900"
      } ${isCollapsed ? "w-10 min-w-10 h-10 justify-center p-0" : "w-full h-10 px-3 py-2"}`}
      style={{ transitionTimingFunction: softSpringEasing }}
      onClick={handleClick}
      title={isCollapsed ? item.label : undefined}
    >
      <div className="flex items-center justify-center shrink-0">
        {item.icon ? React.cloneElement(item.icon as any, { size: 18, className: isActive ? "text-gray-900" : "text-gray-500" }) : null}
      </div>

      <div
        className={`relative transition-opacity duration-500 overflow-hidden ${
          isCollapsed ? "opacity-0 w-0 absolute whitespace-nowrap" : "flex-1 opacity-100 ml-3"
        }`}
        style={{ transitionTimingFunction: softSpringEasing }}
      >
        <div className="font-medium text-sm leading-[20px] truncate">
          {item.label}
        </div>
      </div>
      ...
      {item.hasDropdown && (
        <div
          className={`flex items-center justify-center shrink-0 transition-opacity duration-500 ${
            isCollapsed ? "opacity-0 w-0 absolute" : "opacity-100 ml-2"
          }`}
          style={{ transitionTimingFunction: softSpringEasing }}
        >
          <ChevronDownIcon
  ...
  return (
    ...
    >
      {item.href ? (
        <Link href={item.href} className={`w-full ${isCollapsed ? "flex justify-center" : ""}`}>
          {linkEl}
        </Link>
      ) : (
        linkEl
...
function SubMenuItem({ item }: { item: MenuItemT }) {
  ...
  const content = (
    <div
      className={`h-9 w-full rounded-lg cursor-pointer transition-colors flex items-center px-3 py-1 ${
        isActive ? "bg-gray-200" : "hover:bg-gray-100"
      }`}
    >
      <div className="flex-1 min-w-0">
        <div className={`text-sm leading-[18px] truncate ${isActive ? "text-gray-900 font-medium" : "text-gray-600"}`}>
          {item.label}
        </div>
      </div>
    </div>
...
export function TwoLevelSidebar({ isCollapsed = false, toggleCollapse }: { isCollapsed?: boolean; toggleCollapse?: () => void }) {
  const pathname = usePathname();
  let activeNav = "dashboard";
  if (["/projects", "/business", "/researchers", "/research"].some(x => pathname.startsWith(x))) activeNav = "discover";
  if (["/assistant", "/analytics"].some(x => pathname.startsWith(x))) activeNav = "intelligence";
  if (pathname.startsWith("/settings")) activeNav = "settings";

  const [activeSection, setActiveSection] = useState(activeNav);
  ...
  return (
    <div className="flex flex-row h-screen fixed left-0 top-0 z-40 bg-white shadow-sm border-r border-gray-200">
      <IconNavigation activeSection={activeSection} onSectionChange={setActiveSection} />
      <DetailSidebar activeSection={activeSection} isCollapsed={isCollapsed} toggleCollapse={() => toggleCollapse && toggleCollapse()} />
    </div>
  );
}
