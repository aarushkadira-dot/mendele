  ...
  return (
    ...
    >
      <GlassCard
        variant="default"
        className={cn(
          "h-full flex flex-col group cursor-pointer border-white/10 hover:border-primary/40 transition-all duration-500",
      ...
      >
        ...
        >
          ...
          <div className="absolute top-3 right-3 flex gap-2">
            {opportunity.matchScore >= 80 && (
              <Badge className="bg-primary/90 text-primary-foreground border-0 gap-1 backdrop-blur-md">
          ...
          <div className="absolute -bottom-6 left-5">
            <div className="p-1 rounded-2xl bg-white shadow-2xl">
        ...
        <div className="flex-1 px-5 pt-10 pb-5 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <div className="flex items-center gap-1 text-[11px] font-medium text-muted-foreground bg-white/5 px-2 py-1 rounded-md border border-white/10">
          ...
          <div className="pt-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="default"
                size="sm"
                className="h-8 px-3 rounded-full gap-1.5 text-xs font-bold shadow-lg shadow-primary/20 backdrop-blur-md"
              >
                Learn More
