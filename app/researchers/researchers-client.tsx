...
type SearchType = "researchers" | "investors" | "both"
...
export function ResearchersClient({ studentProfile }: ResearchersClientProps) {
  ...
  const [searchType, setSearchType] = useState<SearchType>("researchers")
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 max-w-7xl py-8 space-y-8">
      ...
      <div className="space-y-1">
        <h1 className="text-3xl font-bold tracking-tight">Find Researchers & Investors</h1>
        <p className="text-muted-foreground">
          Discover researchers and investors to reach out to — scored by collaboration likelihood.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-border/50 bg-card p-5 space-y-4">
        ...
        <div className="flex items-center gap-2">
          {(["researchers", "investors", "both"] as SearchType[]).map((t) => (
            <button
              key={t}
